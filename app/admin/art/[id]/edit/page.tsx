    ...
    <AdminLayout>
      <div style={{ maxWidth: '700px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {saved && (
            <div style={{ background: '#f0fff4', border: '2px solid #22c55e', borderRadius: '8px', padding: '0.75rem 1rem', color: '#166534', fontWeight: 700, marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
